...
_Food _$FoodFromJson(Map<String, dynamic> json) => _Food(
  ...
  ingredients:
      ...
      const <Ingredient>[],
  ingredientsTr:
      (json['ingredients_tr'] as List<dynamic>?)
          ?.map((e) => Ingredient.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const <Ingredient>[],
  ingredientsRaw:
      (json['ingredientsRaw'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
  ingredientsRawTr:
      (json['ingredients_raw_tr'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
  instructions:
      ...
      const <String>[],
  instructionsTr:
      (json['instructions_tr'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
  cookingMethods:
      (json['cookingMethods'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
  implementsList:
      (json['implements'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
  ...
  nutritionRaw:
      (json['nutrition_raw'] as Map<String, dynamic>?)?.map(
