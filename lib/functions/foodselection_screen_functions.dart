...
class IngredientSearchDropdown extends StatefulWidget {
  ...
  final List<IngredientClass> dropdownSelectedItems;
  final ValueChanged<List<IngredientClass>> onItemsChanged;
...
class _IngredientSearchDropdownState extends State<IngredientSearchDropdown> {
  final GlobalKey<DropdownSearchState<IngredientClass>> _dropdownKey = GlobalKey<DropdownSearchState<IngredientClass>>();
  late List<IngredientClass> selectedItems;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownSearch<IngredientClass>.multiSelection(
                      key: _dropdownKey,
                      ...
                      popupProps: PopupPropsMultiSelection.modalBottomSheet(
                        ...
                        itemBuilder: (context, ingredient, isDisabled, isSelected) {
                          final String ingredientName = isTurkish ? ingredient.Ingredient_tr : ingredient.Ingredient;
                          return ListTile(
                            dense: true,
                      ...
                      compareFn: (item, selectedItem) => item.Ingredient == selectedItem.Ingredient && item.Ingredient_tr == selectedItem.Ingredient_tr,
                      ...
                      itemAsString: (IngredientClass ingredient) => isTurkish ? ingredient.Ingredient_tr : ingredient.Ingredient,
...
class _SelectedIngredientsList extends StatelessWidget {
  final List<IngredientClass> items;
  final bool isTurkish;
  final ValueChanged<IngredientClass> onRemove;
...
Future<List<IngredientClass>> fetchFilteredData({required String query, required String tableName, required BuildContext context}) async {
