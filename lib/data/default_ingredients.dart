...
List<IngredientClass> buildDefaultInitialIngredients() {
  ...
  return defaults.map((item) => IngredientClass(Ingredient: item['Ingredient']!, Ingredient_tr: item['Ingredient_tr']!)).toList(growable: true);
}
